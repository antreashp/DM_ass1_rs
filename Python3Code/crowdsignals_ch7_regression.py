...
EXPORT_TREE_PATH = Path('figures/example_graphs/Chapter7_final/')
...
train_X, test_X, train_y, test_y = prepare.split_single_dataset_regression_by_time(dataset, 'acc_x', '2016-02-08 18:28:56',
...
print(dataset.columns)
basic_features = ['acc_x','acc_y','acc_z', 'labelDownstairs','labelJogging','labelSitting','labelStanding','labelUpstairs','labelWalking']
...
for i in tqdm(range(0, len(possible_feature_sets))):
