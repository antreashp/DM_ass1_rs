...
# D:\Users\Andy\Downloads\Desktop\ml4qs\ML4QS_Group_41\ML4QS\simple_dataset\2\accelerometer.csv
    ...
    DATA_PATH = Path('../simple_dataset/')
    DATASET_FNAME = sys.argv[1] if len(sys.argv) > 1 else '2/accelerometer.csv'
    RESULT_FNAME = sys.argv[2] if len(sys.argv) > 2 else 'simple_dataset/chapter3_result_outliers.csv'
    ...
    outlier_columns = ['acc_x', 'acc_y','acc_z']
