...
# D:\Users\Andy\Downloads\Desktop\ml4qs\ML4QS_Group_41\ML4QS\simple_dataset\2\accelerometer.csv
    ...
    for user in range(1,34):
        ...
        outlier_columns = ['actvalue','builtvalue','commvalue','entvalue','accvalue','offvalue','othervalue','socialvalue','travelvalue','unkvalue','utilvalue','callvalue','arovalue','valvalue','scrvalue','smsvalue']
