...
class CreateDataset:
    ...
    def __init__(self, base_dir=base_dir, granularity=granularity):
        self.base_dir = base_dir
        self.granularity = granularity
        # self.data_table = self.create_timestamps(0,1000000000000000)
...
if __name__ == "__main__":
    dataset = CreateDataset(granularity=200)
    dataset.create_dataset(0,1000000000000000,range(5),'')
    dataset.add_numerical_dataset( file, timestamp_col, value_cols, aggregation='avg', prefix='')
